...
<head>
  ...
  $(function() {
	...
	document.getElementById("spot").value=cspot;
	/*
  ...
  <script>
	...
	setCookie("spot",document.getElementById("spot").value,100);
	}
...
<div style="position:absolute;min-height:480px;height:100%;width:100%;max-width:500px;"> 
	...
	<!--<div id="p3" align="center">-->
		<form id="check" action="show2.php" method="GET">
